...
module.exports = function(Contact) {
  ...
  Contact.validatesLengthOf('password', {min: 6, message: {min: 'Password is too short'}, allowBlank: true, allowNull: true});
  Contact.validatesLengthOf('name', {min: 3, message: {min: 'Name is too short'}, allowBlank: true, allowNull: true});
  Contact.validatesLengthOf('name', {min: 3, message: {min: 'Name is too short'}, allowBlank: true, allowNull: true});
  Contact.validatesLengthOf('surname', {min: 3, message: {min: 'Surname is too short'}, allowBlank: true, allowNull: true});
